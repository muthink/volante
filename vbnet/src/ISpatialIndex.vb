...
Namespace Volante
	...
	''' </summary>
	Public Interface ISpatialIndex(Of T As {Class, IPersistent})
		...
		''' </returns>             
		Function [Get](r As Rectangle) As T()
		...
		''' </param>
		Sub Put(r As Rectangle, obj As T)
		...
		''' </exception>
        Overloads Sub Remove(r As Rectangle, obj As T)
		...
		''' is returned.
		''' </returns>
		ReadOnly Property WrappingRectangle() As Rectangle
		...
		''' </returns>
		Function Overlaps(rect As Rectangle) As IEnumerable(Of T)
		...
		''' </returns>
		Function GetDictionaryEnumerator(rect As Rectangle) As IDictionaryEnumerator
